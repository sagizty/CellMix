...
def main(args):
    ...
    Prompt_Token_num = args.Prompt_Token_num  # 10
    ...
    test_model(model, test_dataloader, criterion, class_names, test_dataset_size, model_idx=model_idx,
               test_model_idx=test_model_idx, edge_size=edge_size, Augmentation=Augmentation,
...
def get_args_parser():
    ...
    # todo: whis is a port for you to add strategy in the testing
    parser.add_argument('--fix_position_ratio', default=0.5, type=float, help='CellMix ratio scheduler strategy')
    parser.add_argument('--puzzle_patch_size', default=32, type=int, help='CellMix patch scheduler strategy')
    ...
    parser.add_argument('--batch_size', default=4, type=int, help='testing batch_size default 4 with augmentation')
